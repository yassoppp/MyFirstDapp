...
function extractCallResult(chains, call) {
    ...
    return chainId !== undefined ? (_d = (_c = (_b = (_a = chains[chainId]) === null || _a === void 0 ? void 0 : _a.value) === null || _b === void 0 ? void 0 : _b.state) === null || _c === void 0 ? void 0 : _c[call.address]) === null || _d === void 0 ? void 0 : _d[call.data] : undefined;
}
