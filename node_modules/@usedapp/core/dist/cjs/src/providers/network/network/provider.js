...
function NetworkProvider(_a) {
    ...
    var _e = (0, react_1.useState)(), injectedProvider = _e[0], setInjectedProvider = _e[1];
    var _f = (0, hooks_1.useLocalStorage)('shouldConnectMetamask'), shouldConnectMetamask = _f[0], setShouldConnectMetamask = _f[1];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 5:
                    ...
                    return [2 /*return*/, activate(injectedProvider)];
            }
        });
    }); }, [injectedProvider]);
    ...
    (0, react_1.useEffect)(function () {
        (0, helpers_1.getInjectedProvider)(pollingInterval).then(setInjectedProvider);
    }, []);
    var activate = (0, react_1.useCallback)(function (provider) { return __awaiter(_this, void 0, void 0, function () {
        var wrappedProvider, account, chainId, clearSubscriptions_1, err_3;
        var _a;
