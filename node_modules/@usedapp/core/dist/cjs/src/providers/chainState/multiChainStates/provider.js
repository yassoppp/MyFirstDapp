...
var callsReducer_1 = require("../common/callsReducer");
var chainStateReducer_1 = require("../common/chainStateReducer");
var calls_1 = require("../../../helpers/calls");
...
function MultiChainStateProvider(_a) {
    ...
    var _b = (0, react_1.useReducer)(callsReducer_1.callsReducer, []), calls = _b[0], dispatchCalls = _b[1];
    var _c = (0, react_1.useReducer)(chainStateReducer_1.chainStateReducer, {}), state = _c[0], dispatchState = _c[1];
    ...
    var uniqueCalls = debouncedNetworks === networks ? (0, calls_1.getUniqueCalls)(debouncedCalls) : [];
